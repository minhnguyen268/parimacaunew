...
export const LanguageSelector = ({ fromAdmin }) => {
    ...
    <div style={{ position: "relative", zIndex: 10 }}>
      <img
        ...
        style={{
          ...
          borderRadius: "5px",
          cursor: "pointer",
          marginLeft: status === "authenticated" && !fromAdmin ? "10px" : "0",
        }}
        onClick={(e) => {
          setIsOpenSwitchLanguage(!isOpenSwitchLanguage);
          e.stopPropagation();
        }}
      />
      {isOpenSwitchLanguage && (
        <div
          style={{
            ...
            gap: "8px",
            padding: "8px",
            backgroundColor: fromAdmin ? "#ebebeb" : "rgb(23 46 94)",
            borderRadius: "4px",
          }}
        >
          {Languages.map((l) => (
